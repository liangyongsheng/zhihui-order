...
public class RoomRateGetRequest extends ApiRequest<RoomRateGetResponse> {
	...
	@Override
	public Class<RoomRateGetResponse> getResponseType() {
		return RoomRateGetResponse.class;
	}

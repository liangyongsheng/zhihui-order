...
public class RoomTypeIndexGetRequest extends ApiRequest<RoomTypeIndexGetResponse> {
	...
	@Override
	public Class<RoomTypeIndexGetResponse> getResponseType() {
		return RoomTypeIndexGetResponse.class;
	}
